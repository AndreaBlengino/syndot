...
from syndot.utils.print_ import (print_action, print_relationship,
                                 print_highlight, print_error)
...
class TestPrint:
    ...
    def test_print_action(
            self, action, system_target_path, settings_target_path, capsys):
    ...
    def test_relationship(
            self, symbol, system_target_path, settings_target_path, capsys):
