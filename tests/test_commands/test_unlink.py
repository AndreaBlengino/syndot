...
from tests.test_commands.conftest import generate_unlink_testing_system_files, generate_testing_map_file, TEST_MAP_FILE_PATH
...
class TestUnlink:
    ...
    @given(exact_match = booleans(),
           ...
           target_status = sampled_from(elements = ['targets_to_be_unlinked', 'wrong_existing_links',
                                                    'missing_system_targets', 'already_existing_system',
                                                    'already_unlinked_targets', 'missing_settings_targets',
                                                    'settings_are_links']))
